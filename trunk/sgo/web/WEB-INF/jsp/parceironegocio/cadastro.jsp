						...
						<div class="control-group">
							<div class="controls controls-row">
								<label class="checkbox inline"><input type="checkbox" id="parceiroNegocioIsFuncionario" name="parceiroNegocio.isFuncionario" value="1"
									...
									<c:if test="${usuarioInfo.perfil.chave == 'Consultor' || usuarioInfo.perfil.chave == 'Administrativo' || usuarioInfo.perfil.chave == 'Supervisor' || usuarioInfo.perfil.chave == 'Gestor'}">disabled="disabled"</c:if>>Funcionário
								</label>
								<label class="checkbox inline"><input type="checkbox" id="parceiroNegocioIsCliente" name="parceiroNegocio.isCliente" value="1"
									<c:if test="${parceiroNegocio.isCliente || usuarioInfo.perfil.chave == 'Consultor' || usuarioInfo.perfil.chave == 'Administrativo' || usuarioInfo.perfil.chave == 'Supervisor' || usuarioInfo.perfil.chave == 'Gestor' }">checked="checked"</c:if>> Cliente
								</label>
								<label class="checkbox inline"><input type="checkbox" id="parceiroNegocioIsFornecedor" name="parceiroNegocio.isFornecedor" value="1"
									...
									<c:if test="${usuarioInfo.perfil.chave == 'Consultor' || usuarioInfo.perfil.chave == 'Administrativo' || usuarioInfo.perfil.chave == 'Supervisor' || usuarioInfo.perfil.chave == 'Gestor' }">disabled="disabled"</c:if>> Fornecedor
								</label>
							</div>
						</div>
							...
							<div class="navbar-inner">
								...
								<div id="ajax_endereco" <c:if test="${not empty parceiroNegocio && !parceiroNegocio.isCliente}">style="display: none;"</c:if>>
									...
									<div class="row-fluid">		
										...
										<input class="span2" id="parceirolocalidadeComplemento" name="parceiroLocalidade.complemento" type="text" placeholder="Complemento" value="${parceiroLocalidade.complemento }" maxlength="50" />
										<input class="span9" id="parceirolocalidadePontoReferencia" name="parceiroLocalidade.pontoReferencia" type="text" placeholder="Ponto de Referência" value="${parceiroLocalidade.pontoReferencia }" maxlength="50" />
