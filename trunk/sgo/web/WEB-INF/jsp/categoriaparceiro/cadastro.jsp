...
jQuery(function($){
	...
	$("#categoriaParceiroIsActive").change(function(e){
		$(this).val( $("#categoriaParceiroIsActive:checked").length > 0 ? "1" : "0");
	});
						...
						<div class="span3">
							<form id="categoriaParceiroForm" name="categoriaParceiroForm" action="<c:url value="/categoriaparceiro/salva"/>" method="POST">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="categoriaParceiroDescricao" name="categoriaParceiro.chave" placeholder="Descrição" required>
									</div>
								</div>
								<div class="control-group">
