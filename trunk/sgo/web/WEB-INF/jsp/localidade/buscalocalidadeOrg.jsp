...
<div id="ajax_endereco" style="display: block;width: 920px;">
	...
	<div class="row-fluid">
		...
		<input class="span1" id="organizacaolocalidadeNumero" name="organizacaoLocalidade.numero" type="text" placeholder="Número"/>
	...
	<div class="row-fluid">		
		...
		<input class="span2" id="organizacaolocalidadeComplemento" name="organizacaoLocalidade.complemento" type="text" placeholder="Complemento" />
		<input class="span9" id="organizacaolocalidadePontoReferencia" name="organizacaoLocalidade.pontoReferencia" type="text" placeholder="Ponto de Referência" />
