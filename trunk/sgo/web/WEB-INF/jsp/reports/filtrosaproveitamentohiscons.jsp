...
<div id="content-header">
	<h1>Relatório Aproveitamento Hiscons</h1>
	<div class="btn-group">
	...
	<div id="breadcrumb">
		...
		<a href="#" class="current">Filtros Aproveitamento Hiscons</a>
	</div>
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
		<form id="filtroAprovadosForm" name="filtroAprovadosForm" action="<c:url value="/reports/aproveitamentohiscons"/>" method="POST" target="_blank">
								...
								<div class="span12 center" style="text-align: center;font-size: 7px;">					
										...
										<div class="row-fluid">
											...
											<div class="span2">								
												...
												<input id="data" name="data"  class="input-small" type="text" required="required"/>
											</div>
											<div class="span2">
												<label for="dataFim">Data Fim</label>
												<input id="dataFim" name="dataFim" class="input-small" type="text"  />
											</div>
