...
public class PerfilJanelaAcessoDao extends Dao<PerfilJanelaAcesso> {
	...
	public void insert(PerfilJanelaAcesso perfilJanelaAcesso)
			throws SQLException {

		String sql = "INSERT INTO PERFILJANELAACESSO " + "	(perfil_id, "
				+ "	 janela_id," + "	 empresa_id ," + "	 organizacao_id ,"
				+ "	 isactive) " + "    VALUES (?,?,?,?,?)";
		...
		try {
			...
			this.stmt.setLong(3, perfilJanelaAcesso.getEmpresa()
					.getEmpresa_id());
			this.stmt.setLong(4, perfilJanelaAcesso.getOrganizacao()
					.getOrganizacao_id());
