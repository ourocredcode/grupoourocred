...
public class ContaBancariaDao extends Dao<ContaBancaria> {
	...
	public Collection<ContaBancaria> buscaAllContaBancaria() {
		...
		try {
			...
			while (rsContaBancaria.next()) {
				...
				conta.setContaBancaria_id(rsContaBancaria
						.getLong("contabancaria_id"));
	...
	public Collection<ContaBancaria> buscaContaBancariaByNumeroConta(
			String numeroConta) {
		String sql = sqlContaBancaria;
		if (numeroConta != null)
	...
	public ContaBancaria buscaContaBancariaByAgeNum(Long agencia_id,
			String numeroconta) {
		String sql = sqlContaBancaria;
		if (agencia_id != null)
	...
	public ContaBancaria buscaContaBancariaByEmpOrgAgeNum(Long empresa_id,
			Long organizacao_id, Long agencia_id, String numeroconta) {
		String sql = sqlContaBancaria;
		if (empresa_id != null)
	...
	public ContaBancaria buscaContaBancariaByEmpOrgAgeTipNum(Long empresa_id,
			Long organizacao_id, Long agencia_id, Long tipoconta_id,
			String numeroconta) {
		String sql = sqlContaBancaria;
		if (empresa_id != null)
			sql += " WHERE CONTABANCARIA.empresa_id = ?";
