...
public class ParceiroLocalidadeDao extends Dao<ParceiroLocalidade> {
	...
	public ParceiroLocalidade buscaParceiroLocalidade(Long empresa_id, Long organizacao_id, Long parceironegocio_id, Long localidade_id, Long tipoendereco_id){
		...
		try {
			...
			this.stmt.setLong(1,parceiroLocalidade.getEmpresa().getEmpresa_id());
			this.stmt.setLong(2,parceiroLocalidade.getOrganizacao().getOrganizacao_id());
			this.stmt.setLong(3,parceiroLocalidade.getParceiroNegocio().getParceiroNegocio_id()); 
			this.stmt.setLong(4,parceiroLocalidade.getLocalidade().getLocalidade_id());
			this.stmt.setLong(5,parceiroLocalidade.getTipoEndereco().getTipoEndereco_id());
	...
	public ParceiroLocalidade buscaParceiroLocalidadeNum(Long empresa_id, Long organizacao_id, Long parceironegocio_id, Long localidade_id, Long tipoendereco_id, String numero){
	...
	public ParceiroLocalidade buscaParceiroLocalidadeById(Long parceirolocalidade_id){
