...
public class ContratoDao extends Dao<Contrato> {
	...
	public Collection<Contrato> buscaContrato(Long empresa_id, Long organizacao_id, String nome){
		...
		try {
			...
			while (rsContrato.next()) {
				...
				parceiro.setContrato_id(rsContrato.getLong("parceironegocio_id"));				
	...
	public Contrato buscaContratoDocumento(Long empresa_id, Long organizacao_id, String doc){
