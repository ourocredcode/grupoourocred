...
public class TabelaCoeficienteDao extends Dao<TabelaCoeficiente> {
	...
	public Collection<TabelaCoeficiente> buscaAllTabelaCoeficiente() {
		...
		try {
			...
			while (rsTabelaCoeficiente.next()) {
				...
				coeficiente.setTabelaCoeficiente_id(rsTabelaCoeficiente
						.getLong("tabelacoeficiente_id"));
	...
	public Collection<TabelaCoeficiente> buscaTabelaCoeficienteByNome(
			String nome) {
		String sql = sqlTabelaCoeficiente;
		if (nome != null)
	...
	public TabelaCoeficiente buscaTabelaCoeficienteByEmOrNo(Long empresa,
