...
import br.com.sgo.dao.MenuSgoDao;
...
@Resource
public class MenusgoController {

	private final Result result;
	private final Validator validator;
	private final EmpresaDao empresaDao;
	private final OrganizacaoDao organizacaoDao;
	private final MenuSgoDao menuDao;

	public MenusgoController(Result result,Validator validator, EmpresaDao empresaDao, OrganizacaoDao organizacaoDao,MenuSgoDao menuDao){
	...
	@Public
	@Path("/menu/salva")
	public void salva(MenuSgo menu){
