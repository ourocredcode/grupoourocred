...
public class ContratoController {
	...
	public void altera(Contrato contrato) {
		...
		if(this.contrato.getProduto().getNome().equals("MARGEM LIMPA") 
				...
				|| this.contrato.getProduto().getNome().equals("MARGEM LIMPA GOVSP")
				...
				|| this.contrato.getProduto().getNome().equals("RECOMPRA GOVSP")
		...
		if(this.contrato.getProduto().getNome().equals("REFINANCIAMENTO") 
				...
				|| this.contrato.getProduto().getNome().equals("REFINANCIAMENTO GOVSP")
		...
		if(this.contrato.getProduto().getNome().equals("CARTAO CREDITO") 
				|| this.contrato.getProduto().getNome().equals("CARTAO CONSIGNADO")
				|| this.contrato.getProduto().getNome().equals("SEGURO VIDA"))
	...
	public void alteraStatus(Contrato contrato) {
		...
		if(!(this.contrato.getEtapa().getEtapa_id().equals(contrato.getEtapa().getEtapa_id()))){
			...
			this.contrato.setUpdatedBy(usuario);
		}
