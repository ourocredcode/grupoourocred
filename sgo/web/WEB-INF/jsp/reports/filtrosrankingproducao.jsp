...
<div id="content-header">
	<h1>Relatório Ranking Produção</h1>
	<div class="btn-group">
	...
	<div id="breadcrumb">
		...
		<a href="#" class="current">Filtros Ranking Produção</a>
	</div>
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
		<form id="filtroAprovadosForm" name="filtroAprovadosForm" action="<c:url value="/reports/rankingproducao"/>" method="POST" target="_blank">
