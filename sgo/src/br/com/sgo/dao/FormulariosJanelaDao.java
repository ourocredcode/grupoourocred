...
public class FormulariosJanelaDao extends Dao<FormulariosJanela> {
	...
	public Collection<FormulariosJanela> buscaFomulariosJanela(Long empresa_id, Long organizacao_id, String nome){
		...
		try {
			...
			while (rsFormulariosJanela.next()) {
				...
				formulario.setFormulariosjanela_id(rsFormulariosJanela.getLong("formulariosjanela_id"));				
