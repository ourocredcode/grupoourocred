...
public class TipoProdutoDao extends Dao<TipoProduto> {
	...
	public Collection<TipoProduto> buscaTipoProdutos(Long empresa_id, Long organizacao_id, String nome){
	...
	public Collection<TipoProduto> buscaTipoProdutos(Long empresa_id, Long organizacao_id){
