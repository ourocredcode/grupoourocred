...
public class ParceiroContatoDao extends Dao<ParceiroContato> {
	...
	public Collection<ParceiroContato> buscaParceiroContatos(
		...
		try {
			...
			while (rsParceiroContato.next()) {
				...
				parceiroContato.setNome(rsParceiroContato
						.getString("parceirocontato_nome"));

				TipoContato tipoContato = new TipoContato();
				tipoContato.setTipoContato_id(rsParceiroContato
						.getLong("tipocontato_id"));
				tipoContato.setNome(rsParceiroContato
						.getString("tipocontato_nome"));
	...
	public ParceiroContato buscaParceiroContatoByEmOrPnegTcNo(Long empresa_id,
			Long organizacao_id, Long parceironegocio_id, Long tipocontato_id,
			String nome) {
		if (empresa_id != null)
	...
	public ParceiroContato buscaParceiroContatoByTcNo(Long tipocontato_id,
			String nome) {
